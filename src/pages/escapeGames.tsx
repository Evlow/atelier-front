...
export default function EscapeGames() {
  ...
  const features = [
    ...
    {
      icon: <VisibilityIcon fontSize="large" sx={{ color: "#8B0000" }} />,
      title: "Expérience immersive",
      description: "Plongez dans un univers captivant et unique.",
    },
    {
      icon: <AutoStoriesIcon fontSize="large" sx={{ color: "#8B0000" }} />,
    ...
    {
      icon: <GroupsIcon fontSize="large" sx={{ color: "#8B0000" }} />,
    ...
    <>
      ...
      <Box sx={{ width: "80%", margin: "40px auto", textAlign: "justify" }}>
        <Typography variant="body1">
          ...
          plusieurs années, je conçois des scénarios qui plongent les
          participants dans des mondes uniques, alliant suspense, réflexion et
          découverte. 
          ...
          En plus de la scénarisation, je développe des mécanismes innovants,
          des automatismes complexes, des éléments de décor immersifs, ainsi que
          des technologies de pointe telles que des animatroniques et des
          hologrammes.
          Ces éléments contribuent à donner vie à des univers où chaque détail
          compte et où les participants se sentent véritablement transportés
          dans une autre réalité. 
          Je m’efforce toujours d’aller au-delà de l’expérience classique de
          l’escape game, en cherchant à surprendre, émerveiller et susciter
          l’émerveillement à chaque étape du parcours.
        </Typography>
      </Box>
      ...
      <Box sx={{ width: "80%", margin: "40px auto", textAlign: "justify" }}>
        <Typography variant="body1">
          ...
          technologie. Je suis convaincue que l’avenir des jeux interactifs réside
          dans la fusion des arts traditionnels du spectacle avec des
          technologies modernes, pour offrir des aventures toujours plus
          intenses, surprenantes et mémorables.
        </Typography>
      </Box>
